...
bool Application::OnInit()
{
  ...
  translator.SetLocale(
      cfg->Get<std::string>("locale_name").value_or(env->GetCurrentLocale()));
...
void Application::OnInitCmdLine(wxCmdLineParser &parser)
{
  static const wxCmdLineEntryDesc cmdLineDesc[] = {
      ...
      {wxCMD_LINE_SWITCH, NULL, "silent", NULL, wxCMD_LINE_VAL_NONE,
       wxCMD_LINE_PARAM_OPTIONAL},
      {wxCMD_LINE_OPTION, NULL, "save-path", NULL, wxCMD_LINE_VAL_STRING,
       wxCMD_LINE_PARAM_OPTIONAL},
      {wxCMD_LINE_PARAM, NULL, NULL, "params", wxCMD_LINE_VAL_STRING,
